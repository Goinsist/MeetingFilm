...
import com.stylefeng.guns.rest.modular.film.cache.JedisPoolWriper;
...
public JedisUtil.Strings createJedisStrings(){
    ...
    @Bean(name="jedisSortedSet")
    public JedisUtil.SortedSet createJedisSortedSet(){
        JedisUtil.SortedSet jedisSortedSet=jedisUtil.new SortedSet();
        return jedisSortedSet;
    }
}
