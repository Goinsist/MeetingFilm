...
//获取三个集合封装成一个对象返回即可
    ...
    @RequestMapping(value = "getHallSeatsJson", method = RequestMethod.GET)
    public ResponseVO getHallSeatsJson(String hallId,String fieldId) {
       JSONObject fileStrByAddress = cinemaServiceAPI.getHallSeatsJson(hallId,fieldId);
       return ResponseVO.success(fileStrByAddress);
