...
//判断是否为已售座位
    ...
    public boolean isNotSoldSeats(String fieldId, String seats) {
        ...
        List<MoocOrder2017T> moocOrderTS = moocOrder2017TMapper.selectList(entityWrapper);
        String[] seatArrs=seats.split(",");
        String[] soldseats;
        List<String> soldList=new ArrayList<>();
        //有任何一个编号匹配上，则直接返回失败
        for(MoocOrder2017T moocOrderT:moocOrderTS){
...
//影片信息
     ...
     int insert= moocOrder2017TMapper.insert(moocOrderT);
      if(insert>0){
...
//根据放映查询，获取所有的已售座位
    ...
    public String getSoldSeatsByFieldId(Integer fieldId) {
       if(fieldId==null){
           ...
           String soldSeats= moocOrder2017TMapper.getSoldSeatsByFieldId(fieldId);
           return  soldSeats;
       }
