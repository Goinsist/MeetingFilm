...
//影片信息
     ...
     int insert= moocOrder2018TMapper.insert(moocOrderT);
      if(insert>0){
   ...
   BigDecimal bigDecimal= result.setScale(2,RoundingMode.HALF_UP);
    ...
    public Page<OrderVO> getOrderByUserId(Integer userId,Page<OrderVO> page) {
        ...
        if(userId==null){
            ...
            List<OrderVO> ordersByUserId = moocOrder2018TMapper.getOrdersByUserId(userId);
...
//根据放映查询，获取所有的已售座位
    ...
    public String getSoldSeatsByFieldId(Integer fieldId) {
       if(fieldId==null){
           ...
           String soldSeats= moocOrder2018TMapper.getSoldSeatsByFieldId(fieldId);
           return  soldSeats;
       }
